 ...
 * Slug: oj24/template-index-blogging
...
<main class="wp-block-group" style="margin-top:0">
	...
	<h1 class="wp-block-heading" style="padding-top:var(--wp--preset--spacing--5);line-height:1"><?php esc_html_e( 'Watch, Read, Listen', 'oj24' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:pattern {"slug":"oj24/posts-1-col"} /-->
</main>
<!-- /wp:group -->
